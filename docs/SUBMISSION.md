...
4. **3:30–4:30 — Gemma on AMD.** "The describe stage — the model that *watches* the video —
   is Gemma 3 27B multimodal, self-hosted on an AMD MI300X via vLLM/ROCm." Show rocm-smi +
