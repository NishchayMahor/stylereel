...
## Project title
StyleReel, Four Voices for Every Video (Gemma on AMD MI300X)
...
video-understanding stage running Gemma 3 27B on an AMD Instinct MI300X.
...
The describe stage, the model that actually watches the video, runs Gemma 3 27B multimodal,
...
video, video-captioning, AMD, MI300X, ROCm, vLLM, Gemma, Fireworks AI, Docker, agents, LLM, multimodal
