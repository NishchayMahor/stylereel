...
StyleReel watches a short video clip and writes a caption in four distinct voices —
`formal`, `sarcastic`, `humorous_tech`, and `humorous_non_tech` — that stay *factually
